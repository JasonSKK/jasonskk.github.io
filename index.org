...
#+BEGIN_EXPORT html
 <div class="box" style='float: right; width: 700px; height: 500px; margin-top:-13cm; margin-right:0cm; padding-top:0px; background-color: transparent; border: 5px solid transparent; text-indent: 10px;'>
#+END_EXPORT
...
#+BEGIN_EXPORT html
 <div class="box" style='float: right; width: 700px; height: 375px; margin-top:-2.75cm; margin-right:0cm; padding-top:0px; background-color: transparent; border: 5px solid transparent;'>
#+END_EXPORT
